  ...
  return (
    <div className="contanier w-full mx-auto px-4">
        ...
        <div className="absolute top-[10rem] right-[50%] translate-x-[50%] md:shadow-2xl rounded-3xl flex flex-col items-center max-w-md w-full p-4">
                    <h3 className="font-Lora font-bold italic mt-4 mb-8">Modifiez votre mot de pass</h3>
                    <p className="text-center my-3">Saisissez un nouveau mot de passe ci-dessous pour modifier votre mot de passe.</p>
