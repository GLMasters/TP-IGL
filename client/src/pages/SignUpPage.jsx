    ...
    </header>
      {
        ...
        <div className='absolute top-[8rem]  right-[50%] translate-x-[50%] max-w-lg w-full md:shadow-2xl rounded-3xl h-fit '>
                <form className='w-full px-4 py-4 flex flex-col items-center'>
                  ...
                  <input type='email' className='Inputsign my-8' placeholder='Adress e-mail' />
                    <div className='relative w-full mx-auto'>
                  <input type={passwordVisible ? "text" :"password"} className='Inputsign my-8' placeholder='mot de passe' />
