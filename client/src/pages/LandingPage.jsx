...
export default function LandingPage() {
  ...
  return (
    ...
    {
      visible && <div className="bgGradient1 absolute top-0 h-full w-full left-0 z-10" onClick={()=>setVisible(false)} />
    }
    ...
    {/* filter bar */}
    {
        ...
        {
          filterMode ? <button onClick={()=>setVisible(true)} className="filterBtn bg-primaryColor text-white py-3 px-4 pr-8 text-lg shadow-lg ml-4">Filter</button> : <h3 className="font-Lora italic font-bold text-3xl mb-6 ml-4">Découvrez nos Articles</h3>
        }
           ...
           <button className="btn1 pl-3 pr-6 text-white py-3 lg:hidden">voir plus</button>
           </div>
