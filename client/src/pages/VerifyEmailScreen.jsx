  ...
  return (
    ...
    {loading && <Spinner />}
        ...
        <div className="absolute top-[10rem] right-[50%] translate-x-[50%] md:shadow-2xl rounded-3xl flex flex-col items-center max-w-md w-full p-4">
                    ...
                    <p className="text-center text-black">Veuillez consulter l'adresse e-mail lm_merabet@esi.dz pour obtenire le code de confirmation</p>
                    ...
                    <button className="my-4 py-4 bg-seconadryColor w-5/6 text-black mb-5" onClick={()=>checkConfirmationCode(codeAuth)}>Continuer</button>
