...
function ArticleFavoris({title, authors, institutions}) {
  ...
  return (
    <div className=' rounded-[30px] bg-white ml-10 mr-10 lg:ml-32 lg:mr-32 mt-5 mb-10'>
   <div className='py-10'>
  ...
  <button><img className='w-20 h-16 pr-2 pb-2 mr-2' src={DeleteArticle} alt="delete" /></button>
  </div>
