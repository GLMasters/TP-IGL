...
class AuthenticationTest(unittest.TestCase):
    ...
    def test_successful_authentication(self):
        ...
        email_input.send_keys('lo_cherguelaine@esi.dz')
        password_input.send_keys('Oussama /12/')

        submit_button.click()

        # verification that we are in the home page
        self.assertIn('Découvrez nos Articles', self.driver.page_source)
    ...
    def test_failed_authentication(self):
        ...
        # Check if the login failed (update with appropriate assertion)
